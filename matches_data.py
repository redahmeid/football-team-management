...
def save_team_fixture(match:Match):
    ...
    insert_query = "INSERT INTO Matches (ID,Opposition,HomeOrAway, Date,Team_ID) VALUES (%s,%s,%s,%s,%s)"

    # Data to be inserted
    id = id_generator.generate_random_number(5)
    data_to_insert = (id,match.opposition,match.homeOrAway,match.date,match.team_id)
